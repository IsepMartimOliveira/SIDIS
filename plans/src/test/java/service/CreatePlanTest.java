...
public class CreatePlanTest {
    ...
    @Test
    public void createTest() throws IOException, URISyntaxException, InterruptedException {
        ...
        when(plansRepository.findByName(Mockito.anyString())).thenReturn(Optional.empty());
        ...
        Plans plans = plansService.create(request,"sdfsfdfsfsdf");
        ...
        when(plansRepository.findByName("New Plan")).thenReturn(Optional.of(plan));
    ...
    @Test
    public void createPlan_SameName() throws IOException, URISyntaxException, InterruptedException {
        ...
        assertThrows(IllegalArgumentException.class, () -> plansService.create(request,"sdfsfdfsfsdf"));
